package Sledge::Template::Xslate::Alloy;
...
sub new {
    ...
    $self->{_options}{module} = ['Text::Xslate::Bridge::Alloy'];
...
Sledge::Template::Xslate::Alloy is Text::Xslate template system for Sledge.
This module is use Text::Xslate::Bridge::Alloy module and use TTerse syntax for Text::Xslate on Sledge::Template::Xslate.
...
L<Text::Xslate> L<Text::Xslate::Syntax::TTerse> L<Text::Xslate::Bridge::Alloy>
L<Template::Alloy> L<Template::Alloy::VMethod>
